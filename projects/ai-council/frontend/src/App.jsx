...
function App() {
  ...
  return (
    <div className="superai-native-wrapper" style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      <div style={{ padding: '1rem 2rem', borderBottom: '1px solid #333', background: '#121212', color: '#eee', flexShrink: 0, fontFamily: 'sans-serif' }}>
         <h1 style={{ margin: '0 0 0.5rem 0', fontSize: '1.5rem', fontWeight: 'bold' }}>SuperAI AI Council</h1>
         <p style={{ margin: 0 }}>
           <a href="/" style={{ color: '#4da6ff', textDecoration: 'none' }}>Memory</a> &middot;{' '}
           <a href="/dashboard" style={{ color: '#4da6ff', textDecoration: 'none' }}>Dashboard</a> &middot;{' '}
           <a href="/charts" style={{ color: '#4da6ff', textDecoration: 'none' }}>Charts</a>
         </p>
      </div>
      <div className="app" style={{ height: '100%', flexGrow: 1 }}>
