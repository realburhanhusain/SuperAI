...
|----|------|-----------|-----|--------|-------|
| T17 | Granular Quotas & Agent Budgets | `core/quota_manager.py` | 2h | `[ ]` | — |
| T18 | Provider API Key Pooling & Rotation | `core/key_pool.py` | 2h | `[ ]` | — |
| T19 | Model Mappings & Aliasing | `core/model_router.py` | 1.5h | `[ ]` | — |
| T20 | Token-Bucket Rate Limiting (RPM/TPM) | `core/rate_limiter.py` | 1.5h | `[ ]` | — |
| T21 | Model Payload Rules & Interceptors | `core/payload_rules.py` | 1.5h | `[ ]` | — |
