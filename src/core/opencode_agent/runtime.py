"""
OpenCode-style agent runtime: tool loop + multi-agent + model-agnostic calls.
"""
...
class AgentRuntime:
    def __init__(
        self,
        store: Optional[OpenCodeSessionStore] = None,
        *,
        use_mock: Optional[bool] = None,
    ):
        self.store = store or OpenCodeSessionStore()
        if use_mock is None:
            try:
